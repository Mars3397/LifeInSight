...
public class PrePostProcessor {
    ...
    private static int mOutputColumn = 21; // left, top, right, bottom, score and 16 class probability
    private static float mThreshold = 0.5f;
...
//        int maxInd = -1;
        for (int i = 0; i < mOutputRow; i++) {
            if (outputs[i * mOutputColumn + 4] > mThreshold) {
                ...
                if (cls == target) {
//                    maxScore = outputs[i* mOutputColumn +4];
//                    maxInd = i;
//                    target = cls;
                    //        if (i != -1) {
                    ...
                    Result result = new Result(target, outputs[i * mOutputColumn + 4], rect);
                    results.add(result);
//        }
                }
            }
