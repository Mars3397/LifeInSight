...
public final class ChatItemBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialCardView leftChatView;

  @NonNull
  public final TextView rightChatTextView;

  @NonNull
  public final MaterialCardView rightChatView;

  private ChatItemBinding(@NonNull RelativeLayout rootView, @NonNull TextView leftChatTextView,
      @NonNull MaterialCardView leftChatView, @NonNull TextView rightChatTextView,
      @NonNull MaterialCardView rightChatView) {
  ...
  public static ChatItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialCardView leftChatView = ViewBindings.findChildViewById(rootView, id);
      ...
      MaterialCardView rightChatView = ViewBindings.findChildViewById(rootView, id);
